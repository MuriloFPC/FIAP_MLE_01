...
_fileNameProd1 = 'ImportacaoVinhos.csv'
_fileNameProd2 = 'ImportacaoEspumantes.csv'
_fileNameProd3 = 'ImportacaoFrescas.csv'
_fileNameProd4 = 'ImportacaoPassas.csv'
_fileNameProd5 = 'ImportacaoSucos.csv'


def download_csv():
    GetCsv('http://vitibrasil.cnpuv.embrapa.br/download/ImpVinhos.csv', _fileNameProd1)
    GetCsv('http://vitibrasil.cnpuv.embrapa.br/download/ImpEspumantes.csv', _fileNameProd2)
    GetCsv('http://vitibrasil.cnpuv.embrapa.br/download/ImpFrescas.csv', _fileNameProd3)
    GetCsv('http://vitibrasil.cnpuv.embrapa.br/download/ImpPassas.csv', _fileNameProd4)
    GetCsv('http://vitibrasil.cnpuv.embrapa.br/download/ImpSuco.csv', _fileNameProd5)
